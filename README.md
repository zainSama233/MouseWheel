...
在设置中点击轮盘预览或左侧列表编辑槽位，拖拽预览交换位置。应用选择与场景暂停见 [配置交互](docs/product-design.md#配置交互)。图标可独立使用内置矢量图标、程序图标或自定义图片。动作分类与功能见 [产品设计](docs/product-design.md#动作体系)，远程 OCR 配置见 [接口说明](docs/ocr-http.md)。
