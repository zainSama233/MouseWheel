...
屏幕标注使用实时透明覆盖层，鼠标穿透遵循 [Windows layered window hit testing](https://learn.microsoft.com/en-us/windows/win32/winmsg/window-features#layered-windows)。窗口焦点策略参考 [Windows 无激活窗口](https://devblogs.microsoft.com/oldnewthing/20240919-00/?p=110283)。浮动工具栏独立于覆盖层；状态与资源生命周期以 [屏幕标注会话](../src/tools/screen_annotation_session.cpp) 为准。产品交互参考 [MarkerOn](https://github.com/ifer47/markeron)。
